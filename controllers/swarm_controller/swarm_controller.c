...
int main(int argc, char **argv)
{
  ...
  */
  ...
  while (wb_robot_step(TIME_STEP) != -1) {
	...
	// Send relevant sensor data to search layer
	...
	// Store previous sensor values for future use
